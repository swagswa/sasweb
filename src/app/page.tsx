            ...
            <div className="grid grid-cols-1 md:grid-cols-12 items-center gap-8">
              <div className="md:col-span-4 md:col-start-2 scroll-animation order-2 md:order-1">
                <div className="relative">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                  художник обучалась в Московском академическом художественном училище, на курсе у Виктора Седова и Владимира Карандаева ,член творческого союза художников России, основательница и совладелица SAS Art Gallery, работает в стиле экспрессионизма, использует акрил, масло, структурные пасты и сусальное золото. У художницы  не обычный пластический язык, который позволяет ей открывать любителям живописи разные грани современного искусства. Кроме того, Надежда объединяет особый ритмический подход, который использует при организации художественного пространства Также большинству своих произведений она посвящает стихи .
Картины  Надежды находятся в частных
коллекциях по всему миру: на Кипре, во Франции, в Америке, Испании, ОАЭ и во многих
других странах, также у многих известных людей в России.В 2024 году Надежда участвовала в 15 выставках, 6 из которых
персональные. Двиптих «душа «находится в коллекции музея центра Есенина ,»Космическая симфония» в государственном музеи космонавтики .Картины художницы выставлялись в Разных государственных музеях страны  в том числе в Тверских музеях (музей Сидорова,музейный выставочный комплекс)
                  </p>
                </div>
              </div>

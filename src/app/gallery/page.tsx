...
const artworks = [
  ...
  ...Array.from({ length: 18 }, (_, i) => {
    ...
    const artists = i < 5 || titles[i] === "Цветение красной яблони" ? "Алексей Фирсов" : "Надежда Елкина";
